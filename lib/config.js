...
const twpConfig = function () {
   ...
   * @typedef {"uiLanguage" | "pageTranslatorService" | "textTranslatorService" | "enabledServices" | "targetLanguage" | "targetLanguageTextTranslation" | "targetLanguages" | "alwaysTranslateSites" | "neverTranslateSites" | "sitesToTranslateWhenHovering" | "langsToTranslateWhenHovering" |
   * "alwaysTranslateLangs" | "neverTranslateLangs" | "customDictionary" | "showTranslateSelectedButton" | "showOriginalTextWhenHovering" | "darkMode" | "popupBlueWhenSiteIsTranslated" | "showButtonInTheAddressBar" | "showTranslatePageContextMenu" | "showTranslateSelectedContextMenu" | "translateClickingOnce" | "translateSelectedWhenPressTwice" | "translateTextOverMouseWhenPressTwice" | "useAlternativeService" | "alwaysTranslateThisSite" | "useKeyboardShortcuts" | "keyboardShortcuts" | "neverTranslateThisLanguage" | "autoTranslateWhenClickingALink" | "translateDynamicallyCreatedContent" | "dontShowIfPageLangIsTargetLang" | "dontShowIfPageLangIsUnknown" | "dontShowIfSelectedTextIsTargetLang" | "dontShowIfSelectedTextIsUnknown" | "dontShowIfThereIsNoTextTranslation" | "dontShowIfThereIsOnlyOneTextTranslation" | "dontShowIfSelectedTextIsBlacklisted" | "showTranslatedTextWhenHoveringThisSite" | "showTranslatedTextWhenHoveringThisLang" | "showReleaseNotes" | "enableDiskCache" | "proxyServers" | "useOldPopup" | "dontSortResults" | "translateTag_pre" | "whenShowMobilePopup" | "enableIframePageTranslation" | "showMobilePopupOnDesktop" | "addPaddingToPage"} ConfigKeys
   */
  const defaultConfig = {
    targetLanguage: (navigator.language || navigator.userLanguage).replace("_", "-"),
    targetLanguageTextTranslation: (navigator.language || navigator.userLanguage).replace("_", "-"),
    targetLanguages: [(navigator.language || navigator.userLanguage).replace("_", "-"), "en", "es"],
    ...
    popupOpeningClosingGestureToTheRight: "yes",
    useOldPopup: "no",
    showReleaseNotes: "yes",
    whenShowMobilePopup: "newtab",
    enabledServices: ["google", "bing", "yandex"],
    dontSortResults: "no",
...
//# sourceMappingURL=../maps/10.1.5.0/config.js.map
